...
public class CollectableManager : MonoBehaviour
{
    ...
    [SerializeField] List<string> collectablePrefabsNames = new List<string>();
    ...
    {
        collectablePrefabsNames.Add(prefab);
        for(int i = 0; i < collectablePrefabsNames.Count; i++)
        {
            if (collectablePrefabsNames[i]  == "") collectablePrefabsNames.RemoveAt(i);
        }
    }
